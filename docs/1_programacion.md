...
### A. Clasificación según la cercanía al Hardware
No todos los lenguajes son iguales. Se clasifican principalmente por su "distancia" respecto a lo que entiende el procesador:

1.  **Lenguaje Máquina (Nivel 0):** Es el código binario puro. Es el único que el ordenador entiende directamente, pero es ilegible para nosotros.
2.  **Lenguajes de Bajo Nivel (Ensamblador):** Son lenguajes que utilizan códigos mnemotécnicos (palabras cortas como `MOV`, `ADD`, `JMP`) para dar órdenes directas al hardware. Son extremadamente rápidos y potentes, pero muy difíciles de escribir y dependen totalmente del tipo de procesador.
...
* **Java:** El estándar para aplicaciones corporativas y grandes sistemas. Es muy robusto y seguro.
...
* **Reconocimiento de patrones:** Identificar similitudes entre problemas que ya hemos resuelto.  
* **Abstracción:** Centrarse en la información importante y descartar el resto.  
* **Diseño de algoritmos:** Crear los pasos necesarios para llegar a la solución.  
